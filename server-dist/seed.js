...
import { DEFAULT_ADMIN, DEMO_MATERIALS, DEMO_PRODUCTS, DEMO_STOCK_LOCATIONS, DEMO_SUPPLIERS, FLUX_CODE_CONFIG, ORDER_STATUS_CONFIG, QC_CHECKLISTS, STEP_DEFINITIONS, STEP_STATUS_CONFIG, } from "./config/constants.js";
...
const ensureDocuments = async (collection, uniqueField, rows) => {
...
export const seedDatabase = async () => {
    ...
    if (!existingAdmin) {
        ...
        const legacyPasswordHash = typeof existingAdmin.password_hash === "string"
            ? existingAdmin.password_hash
            : null;
        await AuthUserModel.updateOne({ email: DEFAULT_ADMIN.email }, {
            $set: {
