...
import { assertCanRecordStage, GOLDEN_THREAD_STAGES, goldenThreadProgress, isGoldenThreadComplete, STAGE_EVENT, stageFromChain, } from "./lot-state-machine.js";
const eventFor = (stage, sequence, prevHash = null) => buildLotEventRecord({
    lotId: "LOT-GT-1",
