...
export const REGULATED_COLLECTIONS = new Set([
...
export const isRegulatedCollection = (table) => REGULATED_COLLECTIONS.has(table);
export const isAppendOnlyCollection = (table) => APPEND_ONLY_COLLECTIONS.has(table);
export const isCoreSchemaCollection = (table) => CORE_SCHEMA_COLLECTIONS.includes(table);
