...
const seedPremiumChainThroughTriage = (lotId) => {
    ...
    const triage = buildLotEventRecord({ lotId, eventType: "TRANSFORMED", collection: "triage_sessions", action: "GATE", prevHash: ccp.hash }, 4);
...
describe("packagingService.sealPalette ledger", () => {
    ...
    it("appends PACKED when sealing a palette linked to a golden-thread lot", async () => {
        ...
        store.lot_events = seedPremiumChainThroughTriage(lotId);
