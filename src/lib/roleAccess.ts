...
const ROLE_WORKSPACES: Record<ActorRole, RoleWorkspaceProfile> = {
  ...
  responsable_production: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'production', 'packaging', 'storage', 'alerts'],
  ...
  responsable_qualite: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'receptions', 'quality', 'alerts', 'storage'],
    quickTabs: ['maintenance', 'sage-operations', 'analytics', 'hr'],
  ...
  inspecteur_qualite: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'receptions', 'alerts'],
  ...
  chef_reception: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'receptions', 'storage', 'alerts'],
  ...
  operateur_nettoyage: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'production', 'alerts'],
    quickTabs: ['home'],
  ...
  operateur_conditionnement: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'packaging', 'alerts'],
    quickTabs: ['home'],
  ...
  magasinier_wms: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'storage', 'alerts'],
    quickTabs: ['home'],
  ...
  responsable_logistique: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'logistics', 'export', 'storage', 'alerts'],
  ...
  responsable_achats: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'purchasing', 'suppliers', 'materials', 'alerts'],
    quickTabs: ['analytics', 'hr'],
  ...
  responsable_maintenance: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'maintenance', 'alerts'],
  ...
  auditeur_externe: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'quality', 'alerts', 'receptions'],
    quickTabs: [],
  ...
  technico_commercial: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'export', 'customers', 'purchasing', 'logistics'],
    quickTabs: ['analytics', 'storage'],
  ...
  directeur_achat: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'purchasing', 'suppliers', 'analytics'],
  ...
  resp_management_qualite: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'receptions', 'quality', 'alerts'],
  ...
  responsable_stock: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'storage', 'alerts', 'purchasing'],
