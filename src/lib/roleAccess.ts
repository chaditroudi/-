...
const ROLE_WORKSPACES: Record<ActorRole, RoleWorkspaceProfile> = {
  directeur_usine: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'production', 'packaging', 'receptions', 'storage', 'alerts', 'analytics', 'sage-operations'],
  ...
  directeur_general: {
    ...
    defaultTab: 'home',
    primaryTabs: ['home', 'analytics', 'alerts', 'sage-operations', 'production', 'packaging', 'receptions'],
  ...
  responsable_logistique: {
    ...
    primaryTabs: ['logistics', 'storage', 'alerts', 'home'],
  ...
  technico_commercial: {
    ...
    defaultTab: 'purchasing',
    primaryTabs: ['purchasing', 'logistics', 'home'],
    quickTabs: ['analytics'],
