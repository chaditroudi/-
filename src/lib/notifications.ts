...
const entityRouteMap: Record<string, string> = {
  ...
  // L'onglet Lots Qualité a été supprimé — la QC des lots vit sous Réception.
  batch: buildTabRoute('receptions'),
  batches: buildTabRoute('receptions'),
  ...
  maintenance: buildTabRoute('maintenance'),
  maintenance_requests: buildTabRoute('maintenance'),
