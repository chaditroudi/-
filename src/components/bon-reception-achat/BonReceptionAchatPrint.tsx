...
const Row = ({ label, gc, rp, gcm, l, poidBrut, poidNet }: {
  ...
  <tr className="border border-[#1a5276] text-center text-[11px]">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-stretch border-2 border-[#1a5276] mb-2">
        ...
        <div className="border-r border-[#1a5276] flex items-center justify-center px-4 py-2" style={{ minWidth: 120 }}>
          <div className="text-center">
            ...
            <div className="text-[8px] text-gray-500">Group</div>
          </div>
        </div>
        ...
        {/* Right meta */}
        <div className="flex flex-col justify-between text-[11px] px-3 py-2" style={{ minWidth: 140 }}>
      ...
      <div className="flex gap-2 mb-2">
        ...
        <div className="flex-1">
          <table className="w-full border-collapse text-[10px]">
            ...
            <tbody>
              ...
              {/* Casse */}
              <tr className="bg-[#d6eaf8] text-[10px]">
        ...
        {/* Right column */}
        <div className="flex flex-col gap-1 text-[10px]" style={{ minWidth: 148 }}>
      ...
      {/* Footer */}
      <div className="border-t border-[#1a5276] pt-1 text-[9px] text-gray-500 flex justify-between">
